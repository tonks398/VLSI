...
user = ""
while user != "g" and user != "c":
    user = input("Enter g for gecode or c for chuffed: ")
if user == "g":
...
#         timeout = time.time() + 60*5
        ...
        if elapsed_time > 300:
            ...
            circuits = get_circuits(cx, cy, start_x, start_y)
            plot_solution(circuits, w, height,f'{sorted_ins[i]}', f'../out/norot/images/out-{sorted_ins[i]}.png')
            write_sol(w, n, cx, cy, start_x, start_y, height, out, elapsed_time)
